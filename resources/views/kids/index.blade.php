        ...
        <div class="container">
            <div>
                ...
                <div class="catalog-hero-btns">
                    ...
                    <a href="{{ $pageSettings->kids_wa_url }}" class="btn-outline-white" target="_blank" rel="noopener">
    ...
    <section class="section">
        <div class="container">
            <div class="catalog-head section-center" style="margin-bottom: 32px;">
                ...
                <h2 class="section-title">{{ $pageSettings->kids_journey_title ?: '💡 😊 Comment se déroule la séance ?' }}</h2>
                @if ($pageSettings->kids_journey_subtitle)
                    <p class="section-sub">{{ $pageSettings->kids_journey_subtitle }}</p>
                @endif
            </div>
            <div class="journey-steps">
                @foreach ($pageSettings->kids_journey_items ?? [] as $step)
                    <div class="step-card">
